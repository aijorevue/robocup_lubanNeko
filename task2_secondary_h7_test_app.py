...
HTD85_AUX_HIGH = {14: 300, 15: 600, 17: 450}  # ID14 stays retracted outside task one
GRIPPER_CLOSED = 450
GRIPPER_OPEN = 600
ARM_TIME_MS = 600
...
def run(args) -> int:
    ...
    try:
        ...
        boards.pose_high()
        print("TASK2 HIGH_POSE_READY ID1=650 ID2=600 ID6=350 ID14=300 ID15=600 ID17=450", flush=True)
