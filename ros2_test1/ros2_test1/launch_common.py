"""Shared launch assembly for the RK and RCT6 grasp apps."""
...
MODE_PROFILES = {
    "rk": {
        ...
        "grasp_command_interval": "0.24",
        "grasp_stable_frames": "5",
        "grasp_id2_pixel_gain": "0.107",
        "grasp_id6_pixel_gain": "0.074",
        "grasp_id6_max_step_ticks": "12",
        "grasp_id1_pixel_gain_y": "0",
        "grasp_max_step_ticks": "22",
    ...
    "rk_chassis": {
        "executable": "target_vision",
        "node_name": "red_square_chassis_rk_direct_vision",
        "detect_every": "1",
        "preview_id1": "480",
        "preview_id2": "10",
        "preview_id4": "1120",
    ...
    "rc": {
        "executable": "target_vision_rc",
        "node_name": "red_square_grasp_rc_vision",
        "detect_every": "2",
        "preview_id1": "550",
        "preview_id2": "300",
        "preview_id4": "1000",
        "preview_id6": "510",
        "grasp_id4_closed": "1000",
        "grasp_id4_open": "1500",
        "servo_angle_gap_deg": "0",
        "grasp_command_interval": "0.20",
        "grasp_stable_frames": "1",
        "grasp_id2_pixel_gain": "0.15",
        "grasp_id6_pixel_gain": "0.18",
        "grasp_id6_max_step_ticks": "60",
        "grasp_id1_pixel_gain_y": "0.02",
        "grasp_max_step_ticks": "18",
        "post_center_retreat_mm": "0",
        "post_center_down_mm": "280",
        "timer_period": 1.0,
        "rviz_period": 1.0,
        "extra_args": [],
        "kill_before_start": False,
    },
}
