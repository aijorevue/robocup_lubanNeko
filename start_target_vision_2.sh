...
LOG=/home/cat/ros2_ws/target_vision_2_desktop.log
exec >>"$LOG" 2>&1

echo "==== $(date '+%F %T') start target vision 2.0 ===="
...
pkill -u "$(id -un)" -f "[r]ed_square_grasp_2.launch.py" 2>/dev/null || true
...
flock -u 9
exec 9>&-
exec ros2 launch ros2_test1 red_square_grasp_2.launch.py \
