...
class ChassisStationSafetyTests(unittest.TestCase):
    def test_direct_bridge_synchronizes_multi_servo_motion(self):
        ...
        self.assertEqual(writes[-1][1], target_vision.direct_85kg_start_packet())
        self.assertTrue(all(packet[1][4] == target_vision.DIRECT_CMD_MOVE_TIME_WAIT_WRITE for packet in writes[:3]))
